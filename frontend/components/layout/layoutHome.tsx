...
export default function LayoutHome(props: { children: JSX.Element }) {
  ...
  return (
    <KushareAuthProvider>
      {isFullScreen ? (
        <div className='bg-slate-300 flex gap-x-5 h-screen w-full justify-center py-[1%] xl:px-4 overflow-hidden'>
          <FullScreenMenu />
        ...
        <div className='flex flex-col h-screen w-full'>
          <div className='flex px-[5%] gap-x-2 md:gap-x-6 py-2 items-center mb-2'>
            <RxHamburgerMenu
