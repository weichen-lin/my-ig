...
export default function UploadTasks(props: Pick<OperatorProps, 'uploaderProps'>) {
  ...
  return (
    ...
    >
      <div className='w-full h-12 flex bg-slate-300 m-0'>
        ...
        <Cancel className='h-7 w-7 m-[10px] hover:opacity-60 hover:cursor-pointer' onClick={handleUploaderClose} />
      </div>
